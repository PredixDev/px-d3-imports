...
function runBaseTests() {
  px_d3_imports_1 = document.getElementById('px_d3_imports_1');

  suite('Base Automation Tests for px-d3-imports', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-d3-imports fixture is created', function() {
      assert.isTrue(document.getElementById('px_d3_imports_1') !== null);
    });
